...
public:
    ...
    virtual CurvePtr addCurvePart(CurvePart &cp, std::set<CurveId> *addedCurves, bool setParent = true);
    ...
    virtual void movePoint(CurvePtr c, int i, const vec2d &p, std::set<CurveId> &changedCurves);
