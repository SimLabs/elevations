...
public:
    ...
    HeightMipmap(HeightFunction *height, int topLevelSize, int baseLevelSize, int tileSize, float scale, const std::string &cache);
    ...
    void generate(int rootLevel, int rootTx, int rootTy, float scale, const std::string &file);
