...
public:
     ...
     */
    DrawPlantsShadowTask(const std::string &terrain, ptr<Plants> plants);
...
protected:
     ...
     */
    void init(const std::string &terrain, ptr<Plants> plants);
...
private:
     ...
     */
    std::string terrain; // name of the terrain to be amplified

    std::vector< ptr<TileProducer> > producers;
