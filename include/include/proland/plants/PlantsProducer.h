...
public:
     ...
     * TODO.
     */
    std::vector<vec4d> plantBounds; // frustum z min max, altitude min max
     ...
     * TODO.
     */
    std::vector< ptr<PlantsProducer> > slaves;
...
private:
    ...
    static std::map<std::pair<SceneNode*, Plants*>, PlantsProducer*> producers;
