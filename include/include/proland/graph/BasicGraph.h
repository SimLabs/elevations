...
public:
    ...
    inline ptr<CurveIterator> getChildCurves(CurveId parentId)
    {
        ...
        std::pair<MI, MI> range = curves.equal_range(parentId);
     ...
     */
    virtual void load(const std::string &file, bool loadSubgraphs = true);
