...
public:
    ...
    public:
         ...
         */
        EditHydroGraphHandler(EditGraphOrthoLayer *e, ptr<ResourceManager> r, std::string t)
     ...
     */
    EditHydroGraphOrthoLayer(const std::vector< ptr<GraphProducer> > &graphs, ptr<Program> layerProg, int displayLevel = 0, float tolerance = 8.0f / 192.0f, bool softEdition = true, double softEditionDelay = 100000.0, bool deform = false, std::string terrain = "", ptr<ResourceManager> manager = NULL) :
