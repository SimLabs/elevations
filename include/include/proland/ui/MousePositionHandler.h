...
public:
     ...
     */
    MousePositionHandler(std::map<ptr<SceneNode>, ptr<TerrainNode> > terrains, ptr<EventHandler> next);
...
protected:
     ...
     * are used to determine if the point is inside the terrain.
     */
    std::map<ptr<SceneNode>, ptr<TerrainNode> > terrains;
     ...
     */
    void init(std::map<ptr<SceneNode>, ptr<TerrainNode> > terrains, ptr<EventHandler> next);
