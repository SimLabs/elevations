...
namespace elevations
{
	namespace taskgraph
	{
		...
		{
		public:
			set_location_task(const math::lat_lon_d& lat_lon, ptr<dem::lat_lon_converter> lat_lon_converter, dem::elevation_cursor::cursor_state& cursor_state, ptr<TaskGraph> task_graph, unsigned deadline = 0);
